...
function renderCards(list) {
    ...
    if (list.length === 0) {
        container.innerHTML = `<p style="text-align:center;color:#A0826D;padding:2rem;font-size:0.95rem;">Nenhum eletricista disponível ainda. Assim que um profissional se cadastrar nessa área, ele aparece aqui.</p>`;
        return;
    }
